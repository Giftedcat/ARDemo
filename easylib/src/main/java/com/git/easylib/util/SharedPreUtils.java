...
public class SharedPreUtils {
     ...
     * @return SharedPreUtils对象
     */
    public static synchronized SharedPreUtils getInstance(Context context, String spName) {
		if (mSharedPreUtils == null)
            mSharedPreUtils = new SharedPreUtils(context, spName);
     ...
     * @param spName
     */
    private SharedPreUtils(Context context, String spName) {
