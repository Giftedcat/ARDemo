 ...
 */
public class AlertWeightWheelView {
    ...
    private ArrayList<String> mDatas_sub = new ArrayList<>();
    private int posittion;
    private int posittion_sub;
    ...
    private OnWheelSubClickListener onWheelClickListener;
    ...
    public AlertWeightWheelView(Builder builder) {
     ...
     */
    public AlertWeightWheelView(String title, String msg, String cancel, int visibleItems, String[] others, Context context, OnWheelSubClickListener onItemClickListener){
     ...
     * @param onItemClickListener
     */
    public AlertWeightWheelView(String title, String msg, String cancel, int visibleItems, List<String> others, List<String> others_sub, Context context, OnWheelSubClickListener onItemClickListener){
        this.contextWeak = new WeakReference<>(context);
        this.onWheelClickListener = onItemClickListener;

        initData(title, msg, cancel, visibleItems, others, others_sub);
        initViews();
        init();
        initEvents();
    }
     ...
     * @param others
     */
    protected void initData(String title, String msg, String cancel, int visibleItems, List<String> others, List<String> others_sub) {
        ...
        if (others_sub != null){
            this.mDatas_sub.addAll(others_sub);
        }
        if (cancel != null){
            this.cancel = cancel;
        }
    ...
    protected void initAlertWheelView(){
        ...
        WheelView alertwheelView_sub = (WheelView) contentContainer.findViewById(R.id.alertwheel_sub);
        // 添加change事件
        alertwheelView_sub.addChangingListener(new OnWheelChangedListener() {
            @Override
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
                Log.d("AlertWheelView_sub","" + newValue);
                posittion_sub = newValue;
            }
        });
        alertwheelView_sub.setViewAdapter(new ArrayStringWheelAdapter(context, mDatas_sub));
        // 设置可见条目数量
        alertwheelView_sub.setVisibleItems(visibleItems);
    }
    ...
    protected void initAlertWheelViews(LayoutInflater layoutInflater) {
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.layout_alertview_wheel_weight, contentContainer);
        ...
        tvAlertOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onWheelClickListener.onItemClick(AlertWeightWheelView.this , posittion, posittion_sub);
                dismiss();
            }
        });
    }
     ...
     * @return
     */
    public AlertWeightWheelView addExtView(View extView){
    ...
    public AlertWeightWheelView setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    class OnTextClickListener implements View.OnClickListener{
        ...
        public void onClick(View view) {
           // if(onWheelClickListener != null) onWheelClickListener.onItemClick(AlertWeightWheelView.this,position, posittion);
            dismiss();
        }
    ...
    public AlertWeightWheelView setCancelable(boolean isCancelable) {
    ...
    public static class Builder {
        ...
        private int visibleItems;
        private String[] others;
        private OnWheelSubClickListener onItemClickListener;
        ...
        public Builder setOnItemClickListener(OnWheelSubClickListener onItemClickListener) {
            this.onItemClickListener = onItemClickListener;
            return this;
        }

        public AlertWeightWheelView build() {
            return new AlertWeightWheelView(this);
        }
    }
}
