...
final class PicassoDrawable extends BitmapDrawable {
   ...
   * image.
   */
  static void setBitmap(RoundImageView target, Context context, Bitmap bitmap,
    ...
    target.setImageBitmap(drawable.getBitmap());
  }
   ...
   * placeholder image.
   */
  static void setPlaceholder(RoundImageView target, Drawable placeholderDrawable) {
