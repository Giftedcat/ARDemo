...
public class Picasso {
  ...
  final Map<RoundImageView, DeferredRequestCreator> targetToDeferredRequestCreator;
  ...
  Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener,
    ...
    this.targetToDeferredRequestCreator = new WeakHashMap<RoundImageView, DeferredRequestCreator>();
  ...
  public void cancelRequest(RoundImageView view) {
  ...
  void defer(RoundImageView view, DeferredRequestCreator request) {
  ...
  private void cancelExistingRequest(Object target) {
    ...
    if (target instanceof RoundImageView) {
      RoundImageView targetImageView = (RoundImageView) target;
