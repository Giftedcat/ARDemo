...
//                    lunarDay.setTextColor(mAttrsBean.getColorLunar());
                ...
                public void onClick(View v) {
                    ...
                    if (date.getType() == 1) {
                        ...
                        if (lastClickedView != null) {
                            setDayColor(lastClickedView, 0);
                        }
                        setDayColor(v, R.drawable.kj_yz_yz);
                        lastClickedView = v;
    ...
    private void setDayColor(View v, int resource) {
        TextView solarDay = (TextView) v.findViewById(R.id.solar_day);
        LinearLayout ll = (LinearLayout) v.findViewById(R.id.ll);
        TextView txtAm = (TextView) v.findViewById(R.id.txtAm);
        TextView txtPm = (TextView) v.findViewById(R.id.txtPm);
...
//        lunarDay.setTextSize(mAttrsBean.getSizeLunar());
        if (resource == 0){
            ...
            solarDay.setTextColor(Color.BLACK);
        }else {
            ll.setBackgroundResource(resource);
            solarDay.setTextColor(mAttrsBean.getColorChoose());
        }
//        if (attendance[index][0] == 1)
//            txtAm.setVisibility(View.VISIBLE);
//        if (attendance[index][1] == 1)
//            txtPm.setVisibility(View.VISIBLE);
