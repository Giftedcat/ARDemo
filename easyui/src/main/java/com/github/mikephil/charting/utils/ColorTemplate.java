...
public class ColorTemplate {
    ...
    public static int getHunColor() {
        return Color.rgb(230, 0, 18);
    }
    public static int getSuColor() {
        return Color.rgb(0, 160, 233);
    }
    public static int getRiceColor() {
        return Color.rgb(126, 48, 142);
    }
    public static int getBanHunColor() {
        return Color.rgb(69, 138, 0);
    }
    public static int getNoodlesColor() {
