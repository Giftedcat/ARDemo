...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private Button btnOk,capture_button_cancel;
...
//        }
        view = inflater.inflate(R.layout.activity_zxingcamera_child, null);
    ...
    private void initView(View view) {
        etImei = (EditText) view.findViewById(R.id.etImei);
        btnOk = (Button) view.findViewById(R.id.btnOk);
        LinearLayout input_ll = (LinearLayout) view.findViewById(R.id.input_ll);
        input_ll.bringToFront();
        capture_button_cancel = (Button) view.findViewById(R.id.capture_button_cancel);
        capture_button_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                analyzeCallback.btnCancel();
            }
        });
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                analyzeCallback.btnOkClick(imei);
            }
        });
    }
